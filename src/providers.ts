...
const providers: Provider[] = [
  // ── Completely free, no key needed ──
  {
    ...
    models: [
      ...
      { id: 'deepseek', name: 'DeepSeek', contextK: 128, free: true, supportsTools: true, supportsVision: false },
      { id: 'gemini', name: 'Gemini', contextK: 128, free: true, supportsTools: true, supportsVision: false },
      { id: 'qwen-coder', name: 'Qwen Coder', contextK: 128, free: true, supportsTools: true, supportsVision: false },
    ],
  },
  {
    id: 'llm7',
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'llama-3.1-8b-instant', name: 'Llama 3.1 8B', contextK: 128, free: true, supportsTools: true, supportsVision: false },
