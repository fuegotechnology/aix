...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'vibe_all', name: 'Vibe Chameleon', description: 'Try every vibe', emoji: '🦎', condition: s => Object.keys(s.vibeUsage).length >= 40, xp: 200, category: 'vibes' },
  ...
  { id: 'free_only', name: 'Free Spirit', description: 'Use only free providers for 50 messages', emoji: '🆓', condition: s => s.totalMessages >= 50 && Object.keys(s.providerUsage).every(p => {
    const freeIds = ['pollinations','llm7','bazaarlink','ovhcloud','gemini','groq','cerebras','deepseek','mistral','cohere','nvidia','githubmodels','huggingface','siliconflow','chutes','glhf','together','fireworks','opencodezen','kilocode','zhipu','alibabastudio','airforce','nscale','nebius','modelscope','ai21','ollama','lmstudio','jan','vllm','llamacpp','g4f','freechat','shard','aichat','openaiProxy','chatany','freegpt','aiproxy','darkai','nexra','chatgptfree','yuai','zeroone','zephyr','dolphin','topmost','infinity','skyline','freeai','freetheai']
